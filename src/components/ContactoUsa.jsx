...
function ContactoUsa() {
    ...
    const validateForm = () => {
      ...
      if (formData2.nombreApellido.trim() === "") {
        validationErrors.nombreApellido = "First and last name is required";
      }
      if (formData2.pais.trim() === "") {
        validationErrors.pais = "The country is required";
      }
      if (formData2.telefono.trim() === "") {
        validationErrors.telefono = "Telephone is required";
      }
      ...
      if (formData2.preferencia.trim() === "") {
        validationErrors.preferencia = "Preference is required";
      }
      if (formData2.horario.trim() === "") {
        validationErrors.horario = "The schedule is required";
      }
      if (formData2.producto.trim() === "") {
        validationErrors.producto = "The Product is required";
      }
      setFormSubmitted(false);
      ...
      >
        ...
        <div className="inputWrapper">
          <input
            type="text"
            id="horario"
            placeholder="What time do you want us to contact you?"
        ...
        <div className="inputWrapper">
          ...
          >
            ...
            <option value="24 vides">24 vines</option>
            <option value="Hilera">Row</option>
          ...
          Send
                ...
                {formSubmitted && (
                  <span  className="envioExito" >
                    Form submitted successfully! <br></br> In the near future we will contact you.
                  </span>
                )}
                {formNotSubmitted && (
                  <span className="envioExito" >
                   The information could not be sent. <br></br> Please try again later.
                  </span>
                )}
        </div>
      </form>  )
